...
3. Ejecuta en una rama y, antes de pedir nada, **verifica su propio trabajo en código**: recorre los ✅ criterios de cierre de la ficha uno por uno y comenta en el PR un informe con evidencia `file:line` + gates. La ficha es el contrato de validación, y el cierre es contra los objetivos, no contra el checklist.
