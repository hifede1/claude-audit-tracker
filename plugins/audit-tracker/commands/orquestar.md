...
- **Freno anti-loop durante la ejecución**: mismo error tres veces, mismo archivo sin avance real, o un gate que no pasa tras varios intentos = estás trabado. No quemes tokens insistiendo a ciegas: pará, comentá en el issue qué intentaste, qué falla y tu hipótesis, y tratalo como una escalada (draft, espera decisión) — o desistí 🔓 si el bloqueo es de entorno. Trabado que insiste ≠ progreso.
