...
5. **Verificá contra la ficha y dejá evidencia.** Re-auditá tu propio trabajo EN CÓDIGO: recorré los ✅ criterios de cierre de la ficha UNO POR UNO y armá el **informe de verificación**: criterio → cumple / no cumple → evidencia `file:line` + salida de los gates (typecheck, tests, lint). Con un criterio en rojo no se pide validación: volvé al paso 4.
