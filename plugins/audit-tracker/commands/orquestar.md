...
c. **El CÓMO, en las referencias.** 📚 Leé las linkeadas ANTES de escribir código; territorio nuevo sin referencia → generala primero; referencia contradicha por las fuentes actuales → marcala vencida (protocolo de `/proximo-encargo` paso 5).
