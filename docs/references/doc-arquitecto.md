...
fuentes:
  ...
  - claude-doc-arquitecto/docs/FICHA.md — ficha de diseño. ⚠️ NO está firmada bajo el contrato del
    taller: al 2026-07-28 no lleva la línea de ratificación que fija `011`. Lo que tiene es una
...
> ### ⚠️ Corrección de esta referencia (2026-07-28)
>
> Hasta hoy, el bloque `fuentes` de arriba citaba la ficha de `claude-doc-arquitecto` como
> **«contrato de diseño firmado»**. **Es falso**, y se verificó el 2026-07-26 y se re-verificó el 2026-07-28: esa ficha
